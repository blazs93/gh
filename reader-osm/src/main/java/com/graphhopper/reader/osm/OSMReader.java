...
public class OSMReader implements DataReader {
	...
	private boolean isImportant(final ReaderWay item) {
		if (item.getTag("highway") != null) {
			if (((String) item.getTag("highway")).equalsIgnoreCase("motorway")
					|| ((String) item.getTag("highway")).equalsIgnoreCase("trunk")
					|| ((String) item.getTag("highway")).equalsIgnoreCase("primary")
					|| ((String) item.getTag("highway")).equalsIgnoreCase("motorway_link")
					|| ((String) item.getTag("highway")).equalsIgnoreCase("trunk_link")
					|| ((String) item.getTag("highway")).equalsIgnoreCase("primary_link")) {
				return true;
			} else
				return false;
		} else
